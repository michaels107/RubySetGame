...
* 78% Implementation
Use this link to view _[Guidelines](http://web.cse.ohio-state.edu/~shareef.1/3901.su18/labs/GradingGuidelines.pdf)_ when your group is formulating its solution. Though, this is notthe finalized grading template that the graders will use.
